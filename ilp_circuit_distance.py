...
def mip_circuit_distance(dem: stim.DetectorErrorModel, time_limit: int | None = None, *, verbose: bool = False, solver_name: str = None):
    """
    ...
    return {
        ...
        "lower_bound": solver.Objective().BestBound() if hasattr(solver.Objective(), 'BestBound') else distance,
    }
